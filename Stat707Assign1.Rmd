...
'Generate the Beta Distribution Sample Space include 10000 number'
dv <- rbeta(10000,100,5)
hist(dv)
'the Sampe space generated from the Beta Distribution '
plot(density(dv))

sprintf("the Mean of whole sample space is %f",mean(dv))
