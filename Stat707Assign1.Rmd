...
```{r,echo=TRUE}
  ...
  sprintf('The Probability get more than 62 head in 100 tries from all TYPES OF coins P(C) is %f ',p_C)
  
  
 
  print('P(C|A) the Probability get more than 62 head in 100 tries for unbias coin is also a bino distribution:')
  pC_A = 1-pbinom(61,100,0.5)
  sprintf('the probability get more than 62 head in 100 tries for unbias coin is : %f\n',pC_A)
  

  
  print('What we need is P(A|C)=P(C|A)P(A)/P(C): ')
  
  PUnbiasGiven62= pC_A*0.95/p_C
